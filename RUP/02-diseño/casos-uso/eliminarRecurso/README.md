...
## Propósito
Especificar el flujo para la eliminación segura de una entidad Recurso, con confirmación previa del usuario.

## Diagrama de secuencia de diseño

![Diagrama de Secuencia](/images/RUP/02-diseño/casos-uso/eliminarRecurso/secuencia.svg)

[Código PlantUML](secuencia.puml)

## Participantes
*   **Frontend**: Componente de lista con diálogo de confirmación.
*   **API**: Endpoint `DELETE /recursos/{id}`.
*   **RecursoService**: Verifica existencia y coordina la eliminación.
*   **RecursoRepository**: `DELETE` en base de datos.
...
*   El servicio verifica que el recurso existe antes de eliminar (404 si no existe).
