# pySigHor > endSession > Análisis

> |[🏠️](/RUP/README.md)|[ 📊](https://raw.githubusercontent.com/mmasias/pySigHor/main/images/RUP/99-seguimiento/diagrama-contexto-administrador.svg)|[Detalle](/RUP/00-casos-uso/02-detalle/endSession/README.md)|**Análisis**|Diseño|Desarrollo|Pruebas|
> |-|-|-|-|-|-|-|
...
Análisis del caso de uso `endSession()` mediante diagrama de colaboración MVC, identificando clases de análisis y sus interacciones conceptuales para realizar el caso de uso.

### rol metodológico del caso de uso

`endSession()` es el **caso de uso de finalización** del sistema SigHor, funcionando como:
...
|![Análisis endSession()](/images/RUP/01-analisis/casos-uso/endSession/endSession-analysis.svg)|
|-|
...
|-|-|-|
|**CerrarSesionController**|Control y coordinación completa del caso de uso|endSession()|
...
|-|-|-|-|
|**:Sistema Disponible**|**CerrarSesionView**|`endSession()`|Invocación desde completarGestion()|
